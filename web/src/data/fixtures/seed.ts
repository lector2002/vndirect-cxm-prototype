...
{ id:'tp1', stepId:'s1', name:'Form khởi tạo hồ sơ', channel:'app', owner:'Growth',      users:18420, desc:'Màn nhập SĐT và thông tin cơ bản' },
  ...
  signals: [
{ id:'sg1', tpId:'tp1', name:'account_open_started',        st:'live',       pf:['ios','android','web'], es:'client', vol:614,  seen:'27/07 · 14:52', srcId:'src-ga', metrics:['m-completion'], desc:'Khách bấm Mở tài khoản', values:['tapped'] },
    { id:'sg2', tpId:'tp1', name:'account_open_step_viewed',    st:'live',       pf:['ios','android','web'], es:'client', vol:2840, seen:'27/07 · 14:52', srcId:'src-ga', metrics:['m-completion'], desc:'Hiển thị từng bước, bắn lặp theo bước', values:['step_01','step_02','step_03','step_04','step_05','step_06'] },
    { id:'sg3', tpId:'tp2', name:'ekyc_document_capture_result',st:'live',       pf:['ios','android'],       es:'client', vol:920,  seen:'27/07 · 14:50', srcId:'src-ekyc', metrics:['m-ocr'], desc:'Kết quả mỗi lần chụp giấy tờ', values:['success','fail'] },
    { id:'sg4', tpId:'tp2', name:'ekyc_document_fail_reason',   st:'validating', pf:['ios','android'],       es:'client', vol:410,  seen:'27/07 · 13:20', srcId:'src-ekyc', metrics:['m-ocr'], desc:'Lý do thất bại: blur / glare / crop / expired', values:['blur','glare','crop','expired'] },
    { id:'sg5', tpId:'tp3', name:'ekyc_face_liveness_result',   st:'live',       pf:['ios','android'],       es:'client', vol:1180, seen:'27/07 · 14:48', srcId:'src-ekyc', metrics:['m-liveness'], desc:'Kết quả mỗi lần liveness', values:['success','fail'] },
    ...
    { id:'sg7', tpId:'tp4', name:'account_info_edited',         st:'live',       pf:['ios','android'],       es:'client', vol:520,  seen:'27/07 · 14:31', srcId:'src-ekyc', metrics:['m-ocr'], desc:'Khách sửa thông tin OCR đọc sai', values:['name','dob','id_number','address','bank'] },
    { id:'sg8', tpId:'tp5', name:'contract_sign_result',        st:'live',       pf:['ios','android'],       es:'client', vol:430,  seen:'27/07 · 14:40', srcId:null, metrics:['m-contract'], desc:'Kết quả ký hợp đồng điện tử', values:['success','fail'] },
    { id:'sg9', tpId:'tp5', name:'contract_session_abandoned',  st:'designed',   pf:['ios','android'],       es:'client', vol:0,    seen:null, srcId:null, metrics:['m-contract'], desc:'Phiên ký hết hạn — đã có spec, chưa implement', values:[] },
    { id:'sg10',tpId:'tp6', name:'account_activated',           st:'live',       pf:['server'],              es:'server', vol:395,  seen:'27/07 · 14:45', srcId:'src-ga', metrics:['m-completion'], desc:'Tài khoản sẵn sàng giao dịch', values:['activated'] },
    ...
    { id:'sg-dvo-1', tpId:'tp-dvo-1', name:'deriv_open_ineligible_reason',  st:'live',       pf:['ios','android','web'], es:'server', vol:190,  seen:'04/08 · 16:20', srcId:null, metrics:[], desc:'Lý do KHÔNG mở được TK phái sinh — 190 = đúng số failed của bước kiểm tra điều kiện', values:['no_base_account','cccd_not_verified'] },
    { id:'sg-dvo-2', tpId:'tp-dvo-3', name:'deriv_contract_otp_fail_reason', st:'live',      pf:['ios','android','web'], es:'server', vol:238,  seen:'04/08 · 16:18', srcId:null, metrics:[], desc:'Lý do ký hợp đồng OTP không thành — bắn mỗi lần thử nên nhiều hơn số ca trượt cuối cùng', values:['otp_expired','otp_not_received'] },
    { id:'sg-dvo-3', tpId:'tp-dvo-4', name:'deriv_vsdc_approval_result',    st:'live',       pf:['server'],              es:'server', vol:942,  seen:'04/08 · 09:40', srcId:null, metrics:[], desc:'Kết quả VSDC duyệt hồ sơ phái sinh', values:['approved','rejected'] },
    { id:'sg-dvo-4', tpId:'tp-dvo-4', name:'deriv_vsdc_wait_duration',      st:'designed',   pf:['server'],              es:'server', vol:0,    seen:null, srcId:null,            metrics:[], desc:'Dải thời gian chờ VSDC duyệt — đã đề xuất, chưa implement', values:[] },

    { id:'sg-nap-1', tpId:'tp-nap-1', name:'deposit_credit_received',   st:'live',       pf:['ios','android','web','server'], es:'server', vol:9640, seen:'04/08 · 17:02', srcId:null, metrics:[], desc:'Tiền về TK chuyên dụng — giá trị là KÊNH nạp (4 kênh của Sơ đồ 2)', values:['qr','bank_gateway','auto_debit_link','counter'] },
    { id:'sg-nap-2', tpId:'tp-nap-2', name:'deposit_reconcile_fail_reason', st:'live',     pf:['server'],                       es:'server', vol:130,  seen:'04/08 · 17:02', srcId:null, metrics:[], desc:'Lý do không ghép được khoản tiền với chủ tài khoản — 130 = đúng số failed của bước đối soát', values:['holder_not_found','amount_mismatch'] },
    { id:'sg-nap-3', tpId:'tp-nap-3', name:'deposit_credit_timing',      st:'validating', pf:['server'],                       es:'server', vol:9510, seen:'04/08 · 16:55', srcId:null, metrics:[], desc:'Ghi có ngay hay dồn xử lý cuối ngày (khoản nộp 17h–20h)', values:['immediate','end_of_day'] },
    { id:'sg-nap-4', tpId:'tp-nap-1', name:'deposit_amount_band',        st:'gap',        pf:['server'],                       es:'server', vol:0,    seen:null, srcId:null,            metrics:[], desc:'Dải số tiền mỗi lần nạp theo kênh — CHƯA instrument', values:[] },

    { id:'sg-tra-1', tpId:'tp-tra-1', name:'trace_request_created',   st:'live',     pf:['ios','android','web'], es:'server', vol:148, seen:'04/08 · 15:30', srcId:null, metrics:[], desc:'Khách gửi yêu cầu tra soát nạp tiền', values:['created'] },
    { id:'sg-tra-2', tpId:'tp-tra-1', name:'trace_attachment_count',  st:'live',     pf:['ios','android','web'], es:'server', vol:148, seen:'04/08 · 15:30', srcId:null, metrics:[], desc:'Số file chứng từ khách đính kèm — tối đa 5 theo quy định', values:['0','1','2','3','4','5'] },
    { id:'sg-tra-3', tpId:'tp-tra-3', name:'trace_state_entered',     st:'live',     pf:['server'],              es:'server', vol:420, seen:'04/08 · 16:10', srcId:null, metrics:[], desc:'Yêu cầu vào từng trạng thái, bắn lặp — 5 trạng thái sau khi tạo của Sơ đồ 2', values:['cho_tiep_nhan','dang_xu_ly_tttt','cho_ben_thu_ba','hoan_tat','tu_choi'] },
    { id:'sg-tra-4', tpId:'tp-tra-4', name:'trace_sla_breach',        st:'designed', pf:['server'],              es:'server', vol:0,   seen:null, srcId:null,            metrics:[], desc:'Vượt SLA 1 ngày làm việc — đã đề xuất, chưa implement', values:[] },

    { id:'sg-rut-1', tpId:'tp-rut-1', name:'withdraw_request_submitted',    st:'live',       pf:['ios','android','web'], es:'server', vol:3180, seen:'04/08 · 15:58', srcId:null, metrics:[], desc:'Khách gửi lệnh rút tiền về ngân hàng', values:['submitted'] },
    ...
    { id:'sg-rut-3', tpId:'tp-rut-3', name:'withdraw_vneid_fail_reason',    st:'validating', pf:['ios','android'],       es:'server', vol:236,  seen:'04/08 · 15:44', srcId:null, metrics:[], desc:'Lý do trượt xác thực CCCD qua VNeID — 236 = đúng số failed của bước VNeID', values:['timeout','mismatch','app_not_installed'] },
    { id:'sg-rut-4', tpId:'tp-rut-7', name:'withdraw_payout_result',        st:'live',       pf:['server'],              es:'server', vol:2364, seen:'04/08 · 16:02', srcId:null, metrics:[], desc:'Kết quả đẩy lệnh sang ngân hàng thụ hưởng', values:['success','bank_reject'] },
    { id:'sg-rut-5', tpId:'tp-rut-4', name:'withdraw_video_sign_result',    st:'gap',        pf:['ios','android'],       es:'server', vol:0,    seen:null, srcId:null,            metrics:[], desc:'Kết quả chữ ký video call cho TK phái sinh — CHƯA instrument', values:[] },

    { id:'sg-ctn-1', tpId:'tp-ctn-1', name:'internal_transfer_submitted',     st:'live', pf:['ios','android','web'], es:'server', vol:2140, seen:'04/08 · 16:35', srcId:null, metrics:[], desc:'Khách gửi lệnh chuyển tiền giữa hai tiểu khoản của mình', values:['submitted'] },
    { id:'sg-ctn-2', tpId:'tp-ctn-2', name:'internal_transfer_reject_reason',st:'live', pf:['ios','android','web'], es:'server', vol:219,  seen:'04/08 · 16:33', srcId:null, metrics:[], desc:'Lý do lệnh bị từ chối — 219 = tổng failed của ba cổng (42+136+41), không phải số rời', values:['wrong_subaccount_pair','insufficient_available','otp_failed'] },
    { id:'sg-ctn-3', tpId:'tp-ctn-4', name:'internal_transfer_posted',       st:'live', pf:['server'],              es:'server', vol:1918, seen:'04/08 · 16:36', srcId:null, metrics:[], desc:'Hạch toán xong cả hai tiểu khoản', values:['posted'] },
  ],
  metrics: [
