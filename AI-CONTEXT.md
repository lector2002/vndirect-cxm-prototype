...
## Done
- [x] Bổ sung báo cáo Voice of Customer: tổng hợp thumb/survey tại touchpoint thành sentiment, confidence, insight và quyết định theo sản phẩm/dịch vụ.
...
- `app/src/pages/VoiceOfCustomer.tsx` - cảm nhận khách hàng và quyết định sản phẩm.
...
## Last Session
- Done: Thêm Voice of Customer theo sản phẩm, gồm sentiment, response confidence, insight và next action.
