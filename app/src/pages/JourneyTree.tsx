  ...
  },
  {
    ...
    groups: [
      { id: 'account-opening', name: 'Mở tài khoản', description: 'eKYC, thiết lập và kích hoạt tài khoản.', flows: [
        verified('open-account-2026', 'Mở tài khoản mới 2026', 'Luồng S0 Visitor, S1 Account trải nghiệm và S2 Full access.', 'Account Journey · Sơ đồ 9', [step('open-declare', 'Khai báo & tạo S1', 'Thu lead và tạo account trải nghiệm.', ['tp-leadform', 'tp-otp']), step('open-ekyc', 'Xác thực CCCD & khuôn mặt', 'VNeID hoặc NFC, sau đó liveness.', ['tp-idcapture', 'tp-liveness']), step('open-profile', 'Hoàn thiện hồ sơ', 'Bổ sung thông tin và tài khoản ngân hàng chính chủ.', ['tp-profile-form', 'tp-banklink']), step('open-contract', 'Thiết lập & ký hợp đồng', 'Chọn số tài khoản, đọc và ký bộ hợp đồng.', ['tp-contract']), step('open-activate', 'Kích hoạt tài khoản', 'VSDC duyệt và gửi welcome.', ['tp-backoffice'])]),
        verified('customer-verification', 'Xác thực khách hàng', 'Bốn phương thức: CCCD tại VNDIRECT, VNeID/NFC, khuôn mặt và chữ ký.', 'Account Journey · Sơ đồ 2', [step('verify-id', 'Xác thực CCCD', 'Đối chiếu CCCD tại VNDIRECT hoặc dữ liệu quốc gia.', ['tp-idcapture']), step('verify-face', 'Xác thực khuôn mặt', 'Liveness và so khớp khuôn mặt.', ['tp-liveness']), step('verify-signature', 'Xác thực chữ ký', 'Video Call trong giờ phục vụ.', ['tp-profile-form'])]),
      ] },
  ...
  },
  {
    ...
    groups: [
      ...
      { id: 'product-enable', name: 'Kích hoạt sản phẩm', description: 'Mở thêm quyền và sản phẩm sau tài khoản cơ sở.', flows: [
        verified('service-registration', 'Chọn sản phẩm / dịch vụ', 'Phân nhánh sản phẩm cần đăng ký và sản phẩm dùng ngay.', 'Account Journey · Sơ đồ 8', [step('service-check', 'Kiểm tra tài khoản', 'Xác định khách đã có tài khoản cơ sở.', ['tp-profile-form']), step('service-route', 'Chọn sản phẩm', 'Margin, phái sinh, Phái sinh Pro hoặc dùng ngay.', ['tp-market'])]),
  ...
  },
  {
    ...
    groups: [
      { id: 'money-operations', name: 'Money Journey thường xuyên', description: 'Dòng tiền và giao dịch lặp lại trong vòng đời active.', flows: [
        verified('money-overview', 'Tổng quan Money Journey', 'Chuỗi Nạp, Mua, Bán, Rút và nhánh tra soát.', 'Money Journey · Sơ đồ 1', [step('money-in', 'Nạp tiền', 'Ghi có và tăng sức mua.', ['tp-deposit']), step('money-invest', 'Mua / Bán', 'Giao dịch và tất toán sản phẩm.', ['tp-daily']), step('money-out', 'Rút tiền', 'Kiểm tra điều kiện và chi tiền.', ['tp-withdraw'])]),
