...
export const ONBOARDING_PILOT = {
  ...
  evidence: [
    { id: 'EV-101', issueId: 'CXI-021', stepId: 'ob-face', source: 'eKYC event', sourceRef: 'liveness_failed · SDK 4.8.2', occurredAt: '17/07 · 14:42', maskedQuote: 'Mã lỗi LIGHT_CONDITION sau 3 lần thử.', signal: 'Android · thiết bị tầm trung · ánh sáng yếu', customerKey: 'KH•••7A2' },
    { id: 'EV-102', issueId: 'CXI-021', stepId: 'ob-face', source: 'Chat', sourceRef: 'CASE•••1842', occurredAt: '17/07 · 14:31', maskedQuote: 'Tôi đã quay lại nhiều lần nhưng ứng dụng vẫn yêu cầu làm lại từ đầu.', signal: 'Repeat contact · 2 lần trong 40 phút', customerKey: 'KH•••1C9' },
    { id: 'EV-103', issueId: 'CXI-021', stepId: 'ob-face', source: 'Google Play', sourceRef: 'REVIEW•••522', occurredAt: '17/07 · 12:18', maskedQuote: 'Nhận diện khuôn mặt không hoàn tất trên điện thoại Android.', signal: 'Rating 2/5 · Android', customerKey: 'Ẩn danh' },
    { id: 'EV-201', issueId: 'CXI-017', stepId: 'ob-contract', source: 'Funnel event', sourceRef: 'contract_session_abandoned', occurredAt: '17/07 · 13:06', maskedQuote: 'Phiên SmartCA hết hạn trước khi CTA ký được xác nhận.', signal: 'Session timeout · 4m32s', customerKey: 'KH•••8B4' },
    { id: 'EV-202', issueId: 'CXI-017', stepId: 'ob-contract', source: 'Hotline', sourceRef: 'CASE•••1750', occurredAt: '17/07 · 11:49', maskedQuote: 'Không rõ hồ sơ đã ký thành công hay cần thao tác lại.', signal: 'First contact unresolved', customerKey: 'KH•••3D1' },
    { id: 'EV-301', issueId: 'CXI-013', stepId: 'ob-id', source: 'ID capture event', sourceRef: 'id_capture_failed · GLARE', occurredAt: '17/07 · 14:10', maskedQuote: 'Ảnh giấy tờ bị chói; chưa có hướng dẫn thay đổi góc chụp.', signal: 'iOS · fail 3 lần', customerKey: 'KH•••5F6' },
  ] satisfies PilotEvidence[],
  issues: [
    { id: 'CXI-021', title: 'Liveness thất bại lặp lại trên Android', stepId: 'ob-face', metricId: 'm-liveness', actionId: 'CXA-021', evidenceRefs: ['EV-101', 'EV-102', 'EV-103'], severity: 'critical', status: 'investigating', affectedCustomers: 312, repeatContactRate: 29, confidence: 91, trend: 18, priorityScore: 94, hypothesis: 'SDK 4.8.2 nhạy với ánh sáng yếu trên nhóm Android tầm trung.', decision: 'Duyệt rollout hướng dẫn theo điều kiện lỗi và thử SDK patch trên 10% traffic.' },
    { id: 'CXI-017', title: 'Không rõ trạng thái ký hợp đồng', stepId: 'ob-contract', metricId: 'm-contract', actionId: 'CXA-017', evidenceRefs: ['EV-201', 'EV-202'], severity: 'high', status: 'fixing', affectedCustomers: 146, repeatContactRate: 18, confidence: 84, trend: 9, priorityScore: 82, hypothesis: 'CTA và trạng thái SmartCA không phản hồi kịp trước khi session hết hạn.', decision: 'Chốt sticky CTA, trạng thái theo thời gian thực và đường quay lại phiên ký.' },
    { id: 'CXI-013', title: 'Chụp CCCD thất bại nhưng thiếu hướng dẫn', stepId: 'ob-id', metricId: 'm-ocr-evidence', actionId: 'CXA-013', evidenceRefs: ['EV-301'], severity: 'medium', status: 'fixing', affectedCustomers: 228, repeatContactRate: 11, confidence: 72, trend: -4, priorityScore: 68, hypothesis: 'Thông báo lỗi chung không phân biệt chói, mờ và sai khung.', decision: 'Theo dõi reason code sau phát hành và xác nhận evidence coverage đạt mục tiêu trước khi mở rộng hướng dẫn.' },
  ] satisfies PilotIssue[],
  actions: [
    { id: 'CXA-021', issueId: 'CXI-021', title: 'Pilot SDK patch + contextual recovery', owner: 'Minh Quân', accountable: 'Head of Onboarding', dueAt: '25/07', approval: 'pending', delivery: 'backlog', impactValidation: 'not-started', loopClosure: 'blocked', successMetricId: 'm-liveness' },
    { id: 'CXA-017', issueId: 'CXI-017', title: 'Sticky CTA và trạng thái SmartCA', owner: 'Linh Trần', accountable: 'Head of Onboarding', dueAt: '22/07', approval: 'approved', delivery: 'in-progress', impactValidation: 'not-started', loopClosure: 'blocked', successMetricId: 'm-contract' },
    { id: 'CXA-013', issueId: 'CXI-013', title: 'Reason code cho lỗi chụp CCCD', owner: 'Hà Vũ', accountable: 'Data Platform Lead', dueAt: '29/07', approval: 'approved', delivery: 'released', impactValidation: 'monitoring', loopClosure: 'blocked', successMetricId: 'm-ocr-evidence', releaseMarker: 'Mobile 8.12.0 · 16/07', outcome: { observedValue: '91,4%', target: '≥ 90%', period: '16/07–17/07 · 24 giờ sau release', sampleSize: 286, evidenceRef: 'DQ-RUN•••0717' } },
  ] as PilotAction[],
};
