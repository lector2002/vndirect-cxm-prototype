...
export const ONBOARDING_PILOT = {
  ...
  issues: [
    ...
    { id: 'OBI-013', title: 'Chụp CCCD thất bại nhưng thiếu hướng dẫn', stepId: 'ob-id', metricId: 'm-ocr-evidence', actionId: 'OBA-013', evidenceRefs: ['EV-301'], severity: 'medium', status: 'fixing', affectedCustomers: 228, repeatContactRate: 11, confidence: 72, trend: -4, priorityScore: 68, hypothesis: 'Thông báo lỗi chung không phân biệt chói, mờ và sai khung.', decision: 'Theo dõi reason code sau phát hành và xác nhận evidence coverage đạt mục tiêu trước khi mở rộng hướng dẫn.' },
